...
|MedBlock| Jose Luis Martinez | Make medical data more secure using blockchain technology | <code>
...
|Texas A&M Transportation Institute| Stephen Polunsky | Create new public interface for transportation funding model, which enables public and policymakers to see the efects of diferent approaches. | NOT ON SLACK
